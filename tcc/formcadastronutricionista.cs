        ...
        private void Btnsalvar_Click(object sender, EventArgs e)
        {
            try
            {
                    ...
                    )
                {
                    ...
                    DTO.Nutricionista novoUser = new DTO.Nutricionista();
                    ...
                    novoUser.crn = Convert.ToString(txtcrn.Text);
                    novoUser.nascimento = Convert.ToDateTime(maskednascimento.Text);
                    novoUser.endereco = txtendereco.Text;

                    //verifica se foi cadastrado com sucesso
                    var cadastrado = new BLL.NutricionistaBLL().novoNutricionista(novoUser);
                    if (cadastrado >= 1)
                    {
